...
\section{Introdução}
  ...
  Os casos de uso a seguir utilizam a nomenclatura abreviada [UC (NÚMERO DO UC)] seguido de uma breve descrição em forma de título.
  ...
  \actors
    \begin{description}
     \actor{Controle}{descrição do ator.}
     \actor{LED de overflow}{descrição do ator.}
     \actor{LEDs de dados:}{descrição do ator.}
    \end{description}
